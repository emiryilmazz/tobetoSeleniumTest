...
from selenium.webdriver.support.ui import WebDriverWait #ilgili driverı bekleten yapı
...
class Test_Demo:
    ...
    def test_null_value(self):
        ...
        sleep(2)
        expectedMessage = self.waitForElementVisible(driver,((By.XPATH,errorMessage_xpath)))
    ...
    @pytest.mark.parametrize("username",readInvalidDataFromExcel())
