...
class TestTestmenu():
  ...
  def test_testmenu(self):
    ...
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "*[data-test=\"about-sidebar-link\"]")))
